...
[![Documentation](https://img.shields.io/badge/Documentation-%230ABAB5?style=flat&logo=readthedocs&logoColor=black)](https://microsoft.github.io/Alien/dataflow/overview/)&ensp;
...
Dataflow uses Alien to implement `instantiation`, `execution`, and `dataflow` for a given task, with options for batch processing and single processing.
...
You should install the necessary packages in the Alien root folder:
