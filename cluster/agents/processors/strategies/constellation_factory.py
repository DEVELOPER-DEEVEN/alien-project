...
"""
Factory classes for creating network Agent strategies and prompters.
...
class networkStrategyFactory:
    """
    Factory class for creating network processing strategies based on weaving mode.
...
def create_network_strategies_for_mode(
    weaving_mode: WeavingMode,
) -> Dict[str, BaseProcessingStrategy]:
    """
    ...
    """
    return networkStrategyFactory.create_all_strategies(weaving_mode)
