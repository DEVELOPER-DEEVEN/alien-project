...
Processes incoming messages from Alien servers.
...
class MessageProcessor:
    ...
    The MessageProcessor listens for incoming WebSocket messages from Alien servers
    ...
    async def _process_server_message(
        ...
        """
        Process a message received from the Alien server.
    ...
    async def _handle_task_completion(
        ...
        """
        Handle task completion messages from Alien servers.
    ...
    async def _handle_error_message(
        ...
        Processes ERROR type messages from the Alien server. Logs the error and
    ...
    async def _handle_command_message(
        ...
        Processes COMMAND type messages from the Alien server. In network mode,
        commands are typically handled by local clients rather than the network
        ...
        """
        # For network clients, acknowledge and continue processing
        try:
            # Commands are typically handled by local clients, not network
            self.logger.debug(
