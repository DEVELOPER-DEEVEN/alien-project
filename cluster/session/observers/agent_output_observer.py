...
from cluster.core.events import AgentEvent, Event, EventType, IEventObserver
...
from Alien.agents.presenters import PresenterFactory

if TYPE_CHECKING:
    from Alien.agents.presenters.base_presenter import BasePresenter
...
class AgentOutputObserver(IEventObserver):
    ...
    async def _handle_agent_response(self, event: AgentEvent) -> None:
        ...
        try:
            ...
            # Check if this is a network agent response
    ...
    async def _handle_agent_action(self, event: AgentEvent) -> None:
        ...
        try:
            ...
            # Check if this is network editing actions
            ...
            elif output_data.get("action_type") == "network_creation":
