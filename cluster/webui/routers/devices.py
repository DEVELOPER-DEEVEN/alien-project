...
"""
Device management router for cluster Web UI.

This module defines API endpoints for managing devices in the cluster framework.
"""
...
from cluster.webui.models.requests import DeviceAddRequest
from cluster.webui.models.responses import DeviceAddResponse
from cluster.webui.services import ConfigService, DeviceService
...
async def add_device(device: DeviceAddRequest) -> Dict[str, Any]:
    """
    Add a new device to the cluster configuration.
