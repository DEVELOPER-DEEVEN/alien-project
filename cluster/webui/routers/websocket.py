...
"""
WebSocket router for cluster Web UI.
...
from cluster.webui.handlers import WebSocketMessageHandler
...
async def websocket_endpoint(websocket: WebSocket) -> None:
    ...
    - Broadcast cluster events to all connected clients in real-time
