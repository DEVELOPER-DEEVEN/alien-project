import { Message, Device, Task, networkSummary, TaskStatus } from './clusterStore';
...
export const mockMessages: Message[] = [
  {
    ...
    kind: 'user',
    author: 'User',
    content: 'Create a network to process data across multiple devices',
  ...
  },
  {
    ...
    kind: 'response',
    author: 'Alien',
    content: 'I will create a network with multiple tasks distributed across available devices.',
    payload: {
      thought: 'The user wants to create a multi-device network. I need to analyze available devices, design a task graph with proper dependencies, and distribute workload efficiently across the cluster.',
      response: 'I will create a network with multiple tasks distributed across available devices.',
      status: 'completed',
    },
  ...
  },
  {
    ...
    kind: 'response',
    author: 'Alien',
    content: 'Here is the current network status.',
    payload: {
      thought: 'I need to query the network status and present the task execution progress to the user.',
      response: 'Here is the current network status with 3 completed tasks, 1 running task, and 1 pending task.',
      status: 'completed',
    },
...
// Mock network
export const mocknetwork: networkSummary = {
  id: 'network-1',
