...
import { Task } from '../../store/clusterStore';
          ...
          {statusFilters.map((status) => (
            <button
              ...
              className={clsx(
                ...
                filter === status
                  ? 'bg-gradient-to-r from-cluster-blue/40 to-cluster-purple/40 text-white'
                  : 'text-slate-400',
              )}
            >
              {statusLabel[status]}
              ...
              <button
                ...
                className={clsx(
                  ...
                  activeTaskId === task.id
                    ? 'border-cluster-blue/60 bg-cluster-blue/15 shadow-glow'
