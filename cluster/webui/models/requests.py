...
"""
Request models for cluster Web UI.
...
class DeviceAddRequest(BaseModel):
    """
    Request model for adding a new device to the cluster configuration.
...
class ResetMessage(BaseModel):
    ...
    Client sends this to reset the cluster session and clear state.
    """
...
class NextSessionMessage(BaseModel):
    ...
    Client sends this to create a new cluster session while maintaining
