...
"""
Enumerations for the Task System in network V2.
...
class TaskStatus(Enum):
    """
    Represents the status of a task in the network.
    """
...
class networkState(Enum):
    """
    State of the entire task network.
    """
...
class DeviceType(Enum):
    """
    Supported device types in the network.
    """
