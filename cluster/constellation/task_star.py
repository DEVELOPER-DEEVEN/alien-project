...
"""
TaskStar - Individual task representation in network V2.
...
if TYPE_CHECKING:
    from cluster.agents.schema import TaskStarSchema


class TaskStar(ITask):
    """
    Represents an individual task (TaskStar) in the task network.
    ...
    def __init__(
        ...
        # Dependencies managed by Tasknetwork
    ...
    async def execute(
        ...
        try:
            # Execute task directly using networkDeviceManager
    ...
    def add_dependency(self, dependency_task_id: TaskId) -> None:
        """
        Add a dependency (internal use by Tasknetwork).
    ...
    def remove_dependency(self, dependency_task_id: TaskId) -> None:
        """
        Remove a dependency (internal use by Tasknetwork).
    ...
    def add_dependent(self, dependent_task_id: TaskId) -> None:
        """
        Add a dependent (internal use by Tasknetwork).
    ...
    def remove_dependent(self, dependent_task_id: TaskId) -> None:
        """
        Remove a dependent (internal use by Tasknetwork).
