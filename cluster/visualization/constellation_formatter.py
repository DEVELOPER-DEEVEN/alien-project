...
"""
network result formatter for beautiful and structured display.
"""
...
class networkFormatter:
    """Formatter for displaying network execution results in a structured way."""
    ...
    def display_network_result(self, network_data: Dict[str, Any]):
        """
        Display network execution result in a beautiful structured format.

        Args:
            network_data: Dictionary containing network execution data
        """
        self.console.print("\n")
        ...
        # Overview table
        overview = self.create_overview_table(network_data)
        self.console.print(overview)
        self.console.print()

        # Statistics table
        if "statistics" in network_data:
            stats_table = self.create_statistics_table(network_data["statistics"])
        ...
        if "network" in network_data:
            summary = Panel(
                Text(network_data["network"], style="cyan"),
...
def format_network_result(result_data: Dict[str, Any]):
    """
    Utility function to format and display network result.

    Args:
        result_data: Dictionary containing network execution data
    ...
    Example usage:
        ...
        ...     'statistics': {...}
        ... }
        >>> format_network_result(data)
    """
    formatter = networkFormatter()
    formatter.display_network_result(result_data)
...
if __name__ == "__main__":
    ...
    format_network_result(example_data)
