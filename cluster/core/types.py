...
"""
cluster Framework Core Types

This module defines the core type system for the cluster framework,
...
class InetworkManager(ABC):
    ...
    async def create_network(
        ...
        """
        Create a new network from tasks and dependencies.
...
# Exception hierarchy
class clusterFrameworkError(Exception):
    """Base exception for cluster framework."""
...
class TaskExecutionError(clusterFrameworkError):
...
class networkError(clusterFrameworkError):
    """Exception raised during network operations."""

    def __init__(self, network_id: networkId, message: str):
        super().__init__(f"network {network_id}: {message}")
        self.network_id = network_id


class DeviceError(clusterFrameworkError):
...
class ConfigurationError(clusterFrameworkError):
    """Exception raised for configuration errors."""

    pass


class ValidationError(clusterFrameworkError):
...
class ProcessingContext:
    ...
    device_manager: Optional[Any] = (
        None  # networkDeviceManager (avoiding circular import)
    )
