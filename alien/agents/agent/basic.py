...
from alien.llm import llm_call
from alien.module.context import Context
from alien.module.interactor import question_asker
...
class BasicAgent(ABC):
    ...
    def __init__(self, name: str) -> None:
        ...
        alien_config = get_alien_config()
        presenter_type = alien_config.system.output_presenter
            ...
            for index, question in enumerate(question_list):
                if ask_user:
                    ...
                    utils.append_string_to_file(
                        alien_config.system.qa_pair_file, json.dumps(qa_pair)
                    )
...
class AgentRegistry:
    ...
    def register(
        ...
        def decorator(agent_cls: Type["BasicAgent"]) -> Type["BasicAgent"]:
            ...
            if third_party:
                alien_config = get_alien_config()
                enabled = alien_config.system.enabled_third_party_agents
