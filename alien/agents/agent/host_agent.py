...
from alien.agents.agent.app_agent import AppAgent, OpenAIOperatorAgent
from alien.agents.agent.basic import AgentRegistry, BasicAgent
from alien.agents.memory.blackboard import Blackboard
from alien.agents.processors.host_agent_processor import HostAgentProcessor
from alien.agents.processors.schemas.response_schema import HostAgentResponse
from alien.agents.states.host_agent_state import ContinueHostAgentState, HostAgentStatus
...
from alien.prompter.agent_prompter import HostAgentPrompter
...
class AgentConfigResolver:
    ...
    def resolve_app_agent_config(
        ...
        example_prompt = (
            alien_config.system.appagent_example_prompt_as
            if alien_config.system.action_sequence
            else alien_config.system.appagent_example_prompt
        )
        ...
        return dict(
            ...
            app_root_name=root,
            is_visual=alien_config.app_agent.visual_mode,
            main_prompt=alien_config.system.appagent_prompt,
    ...
    def resolve_third_party_config(
        ...
        alien_config = get_alien_config()
        cfg = alien_config.system.third_party_agent_config.get(agent_name, {})
        return dict(
