...
from alien.agents.processors.strategies.processing_strategy import ComposedStrategy
...
if TYPE_CHECKING:
    ...
    from alien.agents.processors.core.processor_framework import ProcessingResult
