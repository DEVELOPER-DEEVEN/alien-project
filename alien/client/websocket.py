...
class ALIENWebSocketClient:
    """
    WebSocket client compatible with FastAPI ALIEN server.
    ...
    def __init__(
        ...
        :param alien_client: Instance of ALIENClient
    ...
    async def register_client(self):
        ...
        self.logger.info(
            f"[WS] [AIP] Attempting to register as {self.alien_client.client_id}"
        )
    ...
    async def heartbeat_loop(self, interval: float = 30) -> None:
        ...
        while True:
            ...
            try:
                ...
                await self.heartbeat_protocol.send_heartbeat(self.alien_client.client_id)
