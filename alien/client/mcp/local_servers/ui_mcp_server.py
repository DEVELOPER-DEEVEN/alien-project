...
from alien.agents.processors.schemas.target import TargetInfo, TargetKind
from alien.automator.action_execution import ActionExecutor
from alien.automator.puppeteer import AppPuppeteer
from alien.automator.ui_control import ui_tree
from alien.automator.ui_control.inspector import ControlInspectorFacade
...
def create_host_action_mcp_server(*args, **kwargs) -> FastMCP:
    ...
    action_mcp = FastMCP("ALIEN UI HostAgent Action MCP Server")
...
def create_app_action_mcp_server(*args, **kwargs) -> FastMCP:
    ...
    action_mcp = FastMCP("ALIEN UI AppAgent Action MCP Server")
...
def create_data_mcp_server(*args, **kwargs) -> FastMCP:
    ...
    data_mcp = FastMCP("ALIEN UI Data MCP Server")
    ...
    def get_desktop_app_info(
        ...
        from alien.agents.processors.schemas.target import TargetKind
    ...
    def add_control_list(control_list: List[Dict[str, Any]]) -> str:
        ...
        try:
            from alien.automator.ui_control.grounding.basic import BasicGrounding
