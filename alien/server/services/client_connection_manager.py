...
class ClientConnectionManager:
    ...
    Responsibilities:
    - Track connected clients (devices and orions) with their AIP protocol instances
    - Manage session-to-client mappings for both orion and device sessions
    - Store and retrieve device system information and configurations
    - Provide client registry and lookup services

    Supports both device clients and orion clients.
    """
    ...
    def __init__(self, device_config_path: Optional[str] = None):
        ...
        # Track orion client -> session_ids mapping
        self._orion_sessions: Dict[str, List[str]] = {}

        # Track device -> session_ids mapping (for orion tasks targeting this device)
    ...
    def add_orion_session(self, client_id: str, session_id: str):
        """
        Track a session started by a orion client.

        :param client_id: The orion client ID.
    ...
    def get_orion_sessions(self, client_id: str) -> List[str]:
        """
        Get all session IDs associated with a orion client.
    ...
    def remove_orion_sessions(self, client_id: str) -> List[str]:
        """
        Remove and return all sessions for a orion client.
    ...
    def add_client(
        ...
        :param client_type: The type of client ("device" or "orion").
    ...
    def get_client_type(self, client_id: str) -> str:
        ...
        :param client_id: The ID of the client.
        :return: The client type ("device" or "orion") or None if not found.
        """
        with self.lock:
            client_info = self.online_clients.get(client_id)
    ...
    def list_clients_by_type(self, client_type: ClientType) -> List[str]:
        ...
        :param client_type: The type of clients to list ("device" or "orion").
