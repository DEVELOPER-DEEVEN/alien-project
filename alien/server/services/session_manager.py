...
class SessionManager:
    ...
    async def cancel_task(
        self, session_id: str, reason: str = "orion_disconnected"
    ) -> bool:
        """
        ...
        :param reason: Reason for cancellation. Options:
                      - "orion_disconnected": Orion client disconnected (don't send callback)
                      - "device_disconnected": Target device disconnected (send callback to orion)
    ...
    async def _run_session_background(
        ...
        try:
            ...
            if cancellation_reason == "device_disconnected":
                ...
                was_cancelled = False  # Still send callback to orion
            else:  # orion_disconnected or other reasons
