...
from alien.trajectory import parser
import alien.utils
...
class EvaluationAgentPrompter(BasicPrompter):
    ...
    def system_prompt_construction(self) -> str:
        ...
        screenshot_key = (
            "screenshots_all"
            if alien_config.system.eva_all_screenshots
    ...
    def user_content_construction_head_tail(
        ...
        if len(trajectory.app_agent_log) >= 0:
            first_screenshot_str = alien.utils.encode_image(
        ...
        last_screenshot_str = alien.utils.encode_image(trajectory.final_screenshot_image)
    ...
    def user_content_construction_all(
        ...
        for log in trajectory.app_agent_log:
            ...
            if self.is_visual:
                ...
                screenshot_str = alien.utils.encode_image(screenshot_image)
        ...
        if self.is_visual:
            ...
            screenshot_str = alien.utils.encode_image(trajectory.final_screenshot_image)
    ...
    def load_single_screenshot(screenshot_path: str) -> str:
        ...
        return alien.utils.encode_image_from_path(screenshot_path)
...
if __name__ == "__main__":
    ...
    eva_prompter = EvaluationAgentPrompter(
        is_visual=True,
        prompt_template=alien_config.system.evaluation_prompt,
