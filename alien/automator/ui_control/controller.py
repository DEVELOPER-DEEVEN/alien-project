...
from alien.automator.basic import CommandBasic, ReceiverBasic, ReceiverFactory
from alien.automator.puppeteer import ReceiverManager
...
if platform.system() == "Windows" and pywinauto:
    if (
        hasattr(alien_config.system, "after_click_wait")
        and alien_config.system.after_click_wait is not None
    ):
        pywinauto.timings.Timings.after_clickinput_wait = (
            alien_config.system.after_click_wait
        )
        pywinauto.timings.Timings.after_click_wait = alien_config.system.after_click_wait
...
class ControlReceiver(ReceiverBasic):
    ...
    def click_input(self, params: Dict[str, Union[str, bool]]) -> str:
        ...
        api_name = alien_config.system.click_api
    ...
    def set_edit_text(self, params: Dict[str, str]) -> str:
        ...
        inter_key_pause = alien_config.system.input_text_inter_key_pause
        ...
        if alien_config.system.input_text_api == "set_text":
        ...
        try:
            ...
            if alien_config.system.input_text_enter and method_name in [
                "type_keys",
                "set_text",
            ]:
