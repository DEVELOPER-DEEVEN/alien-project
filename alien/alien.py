...
args.add_argument(
    "--request",
    "-r",
    help="The description of the request, optional. If not provided, ALIEN will ask the user to input the request.",
    type=str,
    default="",
)
args.add_argument(
