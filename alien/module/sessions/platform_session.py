...
from alien.agents.agent.customized_agent import LinuxAgent, MobileAgent
from alien.agents.agent.host_agent import AgentFactory, HostAgent
...
class WindowsBaseSession(BaseSession):
    ...
    def _init_agents(self) -> None:
        ...
        self._host_agent: HostAgent = AgentFactory.create_agent(
            "host",
            "HostAgent",
            alien_config.host_agent.visual_mode,
            alien_config.system.HOSTAGENT_PROMPT,
            alien_config.system.HOSTAGENT_EXAMPLE_PROMPT,
...
class LinuxBaseSession(BaseSession):
    ...
    def _init_agents(self) -> None:
        ...
        self._agent: LinuxAgent = AgentFactory.create_agent(
            "LinuxAgent",
            "LinuxAgent",
            alien_config.system.third_party_agent_config["LinuxAgent"]["APPAGENT_PROMPT"],
            alien_config.system.third_party_agent_config["LinuxAgent"][
...
class MobileBaseSession(BaseSession):
    ...
    def _init_agents(self) -> None:
        ...
        self._agent: MobileAgent = AgentFactory.create_agent(
            "MobileAgent",
            "MobileAgent",
            alien_config.system.third_party_agent_config["MobileAgent"][
                "APPAGENT_PROMPT"
            ],
            alien_config.system.third_party_agent_config["MobileAgent"][
                "APPAGENT_EXAMPLE_PROMPT"
