...
from alien.module.dispatcher import LocalCommandDispatcher, WebSocketCommandDispatcher
from alien.module.sessions.platform_session import MobileBaseSession
...
class MobileSession(MobileBaseSession):
    """
    A session for ALIEN on Android mobile platform.
...
class MobileServiceSession(MobileSession):
    """
    A session for ALIEN service on Android mobile platform.
