...
"""
Excel MCP Server
Provides MCP interface for Microsoft Excel automation via Alien framework.
"""
...
# Add Alien-Unis to the path
Alien_root = os.path.dirname(os.path.dirname(os.path.dirname(__file__)))
if Alien_root not in sys.path:
    sys.path.insert(0, Alien_root)
...
def main():
    ...
    print("=" * 50)
    print("Alien Hardware MCP Server")
