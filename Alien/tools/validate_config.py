...
class ConfigValidator:
    ...
    REQUIRED_cluster_FIELDS = {
        "network_AGENT": ["API_TYPE", "API_KEY", "API_MODEL"],
    }
    ...
    def validate_fields(self, config: Dict[str, Any]) -> bool:
        ...
        required_fields = (
            ...
            else self.REQUIRED_cluster_FIELDS
        )
...
Examples:
  ...
  python -m Alien.tools.validate_config Alien --show-config
    ...
    parser.add_argument(
        "module",
        choices=["Alien", "cluster", "all"],
        help="Module to validate (Alien, cluster, or all)",
    )
    ...
    modules = ["Alien", "cluster"] if args.module == "all" else [args.module]
    all_valid = True
