...
from Alien.utils import is_json_serializable
...
class ContextNames(Enum):
    ...
    # network-specific context names
    DEVICE_INFO = "DEVICE_INFO"  # List of device information
    network = "network"  # The task network
    WEAVING_MODE = "WEAVING_MODE"  # The weaving mode for network operations
