...
from network.core.events import AgentEvent, Event, EventType, IEventObserver
...
class AgentOutputObserver(IEventObserver):
    ...
    async def _handle_agent_response(self, event: AgentEvent) -> None:
        ...
        try:
            ...
            # Check if this is a orion agent response
    ...
    async def _handle_agent_action(self, event: AgentEvent) -> None:
        ...
        try:
            ...
            # Check if this is orion editing actions
            ...
            elif output_data.get("action_type") == "orion_creation":
