...
class ClientConfigManager:
    ...
    def __init__(self, device_manager: OrionDeviceManager):
        """
    ...
    async def add_device_to_config(
        ...
        :param config: Orion configuration to update
    ...
    def validate_config(self, config: OrionConfig) -> Dict[str, Any]:
        """
    ...
    def get_config_summary(self, config: OrionConfig) -> Dict[str, Any]:
        """
