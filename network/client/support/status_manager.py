...
Handles status reporting and information management for OrionClient.
...
class StatusManager:
    ...
    def get_orion_info(self) -> Dict[str, Any]:
        ...
        :return: Orion status and statistics
        """
    ...
    def get_performance_metrics(self) -> Dict[str, Any]:
        """
        Get performance metrics for the orion.
    ...
    def get_diagnostics_report(self) -> Dict[str, Any]:
        ...
        """
        return {
            "orion_info": self.get_orion_info(),
            "device_health": self.get_device_health_summary(),
