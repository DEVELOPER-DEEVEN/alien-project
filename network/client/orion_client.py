...
"""
Orion Device Management Client

Simplified client focused on device connection and basic task execution.
Serves as a support component for the main NetworkClient system.
"""
...
class OrionClient:
    """
    Device Management Client for Orion System.
    ...
    This client serves as a support component for the main NetworkClient,
    handling device-level operations while complex DAG orchestration
    is handled by the TaskOrionOrchestrator system.
    """
    ...
    def __init__(
        ...
        """
        Initialize the orion client for device management.
        ...
        self.device_manager = OrionDeviceManager(
    ...
    async def initialize(self) -> Dict[str, bool]:
        """
        Initialize the orion client and register devices from configuration.
    ...
    def get_orion_info(self) -> Dict[str, Any]:
        """Get orion information and status."""
        return {
            "orion_id": self.config.task_name,
    ...
    # Configuration Management
    def validate_config(
        self, config: Optional[OrionConfig] = None
    ) -> Dict[str, Any]:
        """Validate a orion configuration."""
...
async def create_orion_client(
    config_file: Optional[str] = None,
    task_name: Optional[str] = None,
    devices: Optional[List[Dict[str, Any]]] = None,
) -> OrionClient:
    """
    Create and initialize a modular orion client.

    :param config_file: Path to configuration file
    :param orion_id: Override orion ID
    :param devices: List of device configurations
    :return: Initialized OrionClient
    """
    # Load configuration
    if config_file:
        config = OrionConfig.from_file(config_file)
    else:
        config = OrionConfig()
    ...
    client = OrionClient(config=config, task_name=task_name)
