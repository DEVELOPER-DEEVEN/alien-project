...
class MessageProcessor:
    ...
    async def _handle_command_message(
        ...
        Processes COMMAND type messages from the ALIEN server. In orion mode,
        commands are typically handled by local clients rather than the orion
        ...
        """
        # For orion clients, acknowledge and continue processing
        try:
