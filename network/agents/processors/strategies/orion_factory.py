...
"""
Factory classes for creating Orion Agent strategies and prompters.
...
class OrionStrategyFactory:
    """
    Factory class for creating Orion processing strategies based on weaving mode.
...
def create_orion_strategies_for_mode(
    weaving_mode: WeavingMode,
) -> Dict[str, BaseProcessingStrategy]:
    """
    ...
    """
    return OrionStrategyFactory.create_all_strategies(weaving_mode)
