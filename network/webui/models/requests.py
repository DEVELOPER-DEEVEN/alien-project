...
"""
Request models for Network Web UI.
...
class DeviceAddRequest(BaseModel):
    """
    Request model for adding a new device to the Network configuration.
...
class ResetMessage(BaseModel):
    ...
    Client sends this to reset the Network session and clear state.
    """
...
class NextSessionMessage(BaseModel):
    ...
    Client sends this to create a new Network session while maintaining
