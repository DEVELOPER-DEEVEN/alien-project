import { Message, Device, Task, OrionSummary, TaskStatus } from './networkStore';
...
export const mockMessages: Message[] = [
  {
    ...
    kind: 'user',
    author: 'User',
    content: 'Create a orion to process data across multiple devices',
  ...
  },
  {
    ...
    kind: 'response',
    author: 'ALIEN',
    content: 'I will create a orion with multiple tasks distributed across available devices.',
    payload: {
      thought: 'The user wants to create a multi-device orion. I need to analyze available devices, design a task graph with proper dependencies, and distribute workload efficiently across the cluster.',
      response: 'I will create a orion with multiple tasks distributed across available devices.',
      status: 'completed',
    },
  ...
  },
  {
    ...
    kind: 'response',
    author: 'ALIEN',
    content: 'Here is the current orion status.',
    payload: {
      thought: 'I need to query the orion status and present the task execution progress to the user.',
      response: 'Here is the current orion status with 3 completed tasks, 1 running task, and 1 pending task.',
      status: 'completed',
    },
...
// Mock Orion
export const mockOrion: OrionSummary = {
  id: 'orion-1',
