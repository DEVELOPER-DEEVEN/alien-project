...
import { Task } from '../../store/networkStore';
          ...
          {statusFilters.map((status) => (
            <button
              ...
              className={clsx(
                ...
                filter === status
                  ? 'bg-gradient-to-r from-network-blue/40 to-network-purple/40 text-white'
                  : 'text-slate-400',
              )}
            >
              {statusLabel[status]}
              ...
              <button
                ...
                className={clsx(
                  ...
                  activeTaskId === task.id
                    ? 'border-network-blue/60 bg-network-blue/15 shadow-glow'
