...
import { MessageKind, useNetworkStore } from '../../store/networkStore';
          ...
          <button
            ...
            className={clsx(
              ...
              messageKindFilter === value
                ? 'bg-gradient-to-r from-network-blue to-network-purple text-white shadow-[0_0_20px_rgba(15,123,255,0.4),0_2px_8px_rgba(123,44,191,0.3)] ring-1 ring-white/20'
