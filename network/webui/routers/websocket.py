...
"""
WebSocket router for Network Web UI.
...
from network.webui.handlers import WebSocketMessageHandler
...
async def websocket_endpoint(websocket: WebSocket) -> None:
    ...
    - Broadcast Network events to all connected clients in real-time
