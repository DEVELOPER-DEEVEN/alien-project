...
"""
Device management router for Network Web UI.

This module defines API endpoints for managing devices in the Network framework.
"""
...
from network.webui.models.requests import DeviceAddRequest
from network.webui.models.responses import DeviceAddResponse
from network.webui.services import ConfigService, DeviceService
...
async def add_device(device: DeviceAddRequest) -> Dict[str, Any]:
    """
    Add a new device to the Network configuration.
