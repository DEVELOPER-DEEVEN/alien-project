...
Processing strategies are assembled and orchestrated by the `LinuxAgentProcessor` class defined in `alien/agents/processors/customized/customized_agent_processor.py`. The processor coordinates the 3-phase pipeline execution.
