...
- Using as Sub-Agent in cluster? See [Using Linux Agent as cluster Device](as_cluster_device.md)
...
- **Cross-Device Workflows**: As a sub-agent in cluster multi-device orchestration

!!!tip "cluster Integration"
    LinuxAgent can serve as a device agent in cluster's multi-device orchestration framework, executing Linux-specific tasks as part of cross-platform workflows alongside Windows and other devices.
    
    See [Using Linux Agent as cluster Device](as_cluster_device.md) for configuration details.
