...
- **Using as Sub-Agent in cluster?** See [Using Mobile Agent as cluster Device](as_cluster_device.md)
...
- [As cluster Device](as_cluster_device.md) - Using Mobile Agent in multi-device workflows
...
!!!tip "cluster Integration"
    MobileAgent can serve as a device agent in cluster's multi-device orchestration framework, executing Android-specific tasks as part of cross-platform workflows alongside Windows and Linux devices.
    
    See [Using Mobile Agent as cluster Device](as_cluster_device.md) for configuration details.
...
4. [As cluster Device](as_cluster_device.md) - Configure for multi-device workflows
