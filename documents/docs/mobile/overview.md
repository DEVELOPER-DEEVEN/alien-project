...
- [As Network Device](as_network_device.md) - Using Mobile Agent in multi-device workflows
...
!!!tip "Network Integration"
    MobileAgent can serve as a device agent in Network's multi-device orchestration framework, executing Android-specific tasks as part of cross-platform workflows alongside Windows and Linux devices.
    
    See [Using Mobile Agent as Network Device](as_network_device.md) for configuration details.
...
4. [As Network Device](as_network_device.md) - Configure for multi-device workflows
