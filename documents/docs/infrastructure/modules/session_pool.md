...
alien_config.system.task_status = True

# Custom status file location
alien_config.system.task_status_file = "/path/to/status.json"
```
...
```python
from alien.module.session_pool import SessionPool
...
# Enable task status tracking
alien_config.system.task_status = True
alien_config.system.task_status_file = "progress.json"
...
### ALIEN Config Settings

| Setting | Type | Purpose |
|---------|------|---------|
| `alien_config.system.eva_session` | `bool` | Enable session evaluation |
| `alien_config.system.task_status` | `bool` | Enable task status tracking |
| `alien_config.system.task_status_file` | `str` | Custom status file path |

### Example Configuration

```yaml
# config/alien/config.yaml
system:
  eva_session: true
  task_status: true
...
# Uses alien_config.system.eva_session for should_evaluate
sessions = factory.create_session(
