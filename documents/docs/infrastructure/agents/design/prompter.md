...
The `Prompter` is a key component of the Alien framework, responsible for constructing prompts for the LLM to generate responses. Each agent has its own `Prompter` class that defines the structure of the prompt and the information to be fed to the LLM.
...
You can find all prompter implementations in the `Alien/prompter` folder.
...
**Template Locations:**
- HostAgent: `Alien/prompts/share/base/host_agent.yaml`
- AppAgent: `Alien/prompts/share/base/app_agent.yaml`
- EvaluationAgent: `Alien/prompts/evaluation/evaluate.yaml`
...
- `Alien/prompts/examples/visual/` - For visual models
- `Alien/prompts/examples/nonvisual/` - For text-only models
...
**Configuration:** Uses `Alien/prompts/evaluation/evaluate.yaml`
...
HOSTAGENT_PROMPT: "./Alien/prompts/share/base/host_agent.yaml"
APPAGENT_PROMPT: "./Alien/prompts/share/base/app_agent.yaml"
EVALUATION_PROMPT: "./Alien/prompts/evaluation/evaluate.yaml"

# Example prompt paths (visual vs. non-visual)
HOSTAGENT_EXAMPLE_PROMPT: "./Alien/prompts/examples/{mode}/host_agent_example.yaml"
APPAGENT_EXAMPLE_PROMPT: "./Alien/prompts/examples/{mode}/app_agent_example.yaml"
...
```python
from Alien.prompter.agent_prompter import AppAgentPrompter
...
The `Prompter` system is implemented in the `Alien/prompter` folder with the following structure:
...
- [Prompts Overview](../../../Alien-Unis/prompts/overview.md) - Prompt template structure
- [Basic Template](../../../Alien-Unis/prompts/basic_template.md) - YAML template format
- [Example Prompts](../../../Alien-Unis/prompts/examples_prompts.md) - Demonstration examples
