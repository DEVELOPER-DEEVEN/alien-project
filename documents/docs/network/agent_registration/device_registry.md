...
```python
from network.client.components import DeviceRegistry, DeviceStatus
...
### With OrionDeviceManager

```python
# OrionDeviceManager uses DeviceRegistry internally
...
4. **Explore Components**: See OrionDeviceManager implementation
