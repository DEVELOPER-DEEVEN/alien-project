...
Edit `config/network/devices.yaml` and add your Linux agent under the `devices` section:
...
### Using Network to Control Linux Agents

Once configured, you can launch Network and it will automatically manage the Linux agents:
...
### Issue 5: Network Cannot Find Device
...
| **Network Integration** | Multi-device orchestration | [Network Overview](../network/overview.md) |
