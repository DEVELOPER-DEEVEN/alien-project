...
> - **Network Integration:** [As Network Device](../mobile/as_network_device.md)
...
- **ALIEN repository** cloned from [GitHub](https://github.com/DEVELOPER-DEEVEN/alien-project)
...
```
config/network/devices.yaml
```

### Add Mobile Agent Configuration

Edit `config/network/devices.yaml` and add your Mobile agent:
...
> 
> **If these don't match, Network cannot control the device!**

### Using Network to Control Mobile Agents

Once configured, launch Network:
...
> - [Mobile Agent as Network Device](../mobile/as_network_device.md)
...
| **Network Integration** | Multi-device orchestration with ALIEN³ | [As Network Device](../mobile/as_network_device.md) |
