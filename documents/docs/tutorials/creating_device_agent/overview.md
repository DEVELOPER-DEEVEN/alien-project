...
This comprehensive tutorial teaches you how to create a new device agent (like `MobileAgent`, `AndroidAgent`, or `iOSAgent`) and integrate it with Alien³'s multi-device orchestration system. We'll use **LinuxAgent** as our primary reference implementation.
...
- Integrate with cluster multi-device orchestration
...
All device agents in Alien³ follow a **unified three-layer architecture**:
...
```mermaid
graph TB
    subgraph "Server Side (Alien/agents/)"
    ...
    subgraph "Client Side (Alien/client/)"
        Client[Alien Client<br/>client.py]
...
|-----------|-----------|---------|
| **Agent Class** | `Alien/agents/agent/customized_agent.py` | LinuxAgent definition |
| **Processor** | `Alien/agents/processors/customized/customized_agent_processor.py` | LinuxAgentProcessor |
| **Strategies** | `Alien/agents/processors/strategies/linux_agent_strategy.py` | LLM & Action strategies |
| **States** | `Alien/agents/states/linux_agent_state.py` | State machine states |
| **Prompter** | `Alien/prompter/customized/linux_agent_prompter.py` | Prompt construction |
| **Client** | `Alien/client/client.py` | Device client entry point |
| **MCP Server** | `Alien/client/mcp/http_servers/linux_mcp_server.py` | Command execution |
...
```python
# Alien/agents/agent/customized_agent.py
...
```python
# Alien/agents/processors/customized/customized_agent_processor.py
...
```python
# Alien/client/mcp/http_servers/mobile_mcp_server.py
...
- **cluster Integration** supports multi-device orchestration
