...
from alien.agents.states.linux_agent_state import ContinueLinuxAgentState
from alien.prompter.customized.linux_agent_prompter import LinuxAgentPrompter
...
from alien.agents.states.mobile_agent_state import ContinueMobileAgentState
from alien.prompter.customized.mobile_agent_prompter import MobileAgentPrompter
...
from alien.agents.processors.context.processing_context import ProcessingPhase
from alien.agents.processors.strategies.app_agent_processing_strategy import (
    AppMemoryUpdateStrategy,
)
from alien.agents.processors.strategies.linux_agent_strategy import (
...
if TYPE_CHECKING:
    from alien.agents.agent.customized_agent import LinuxAgent
...
from alien.agents.processors.strategies.mobile_agent_strategy import (
...
if TYPE_CHECKING:
    from alien.agents.agent.customized_agent import MobileAgent
...
```python
# File: alien/agents/states/linux_agent_state.py
...
```python
# File: alien/agents/states/mobile_agent_state.py
...
```python
# File: alien/agents/processors/strategies/linux_agent_strategy.py
...
```python
# File: alien/agents/processors/strategies/mobile_agent_strategy.py
...
```python
# File: alien/prompter/customized/linux_agent_prompter.py
...
```python
# File: alien/prompter/customized/mobile_agent_prompter.py
...
class TestMobileAgent:
    ...
    def agent(self):
        ...
        return MobileAgent(
            ...
            main_prompt="alien/prompts/third_party/mobile_agent.yaml",
            example_prompt="alien/prompts/third_party/mobile_agent_example.yaml",
            platform="android",
        )
