...
**Path**: `alien/client/mcp/http_servers/linux_mcp_server.py`
...
def main():
    ...
    print("=" * 50)
    print("ALIEN Linux Bash MCP Server")
...
**File**: `alien/client/mcp/http_servers/mobile_mcp_server.py`
...
def main():
    ...
    print("=" * 50)
    print(f"ALIEN Mobile MCP Server ({args.platform.capitalize()})")
...
from alien.client.mcp.http_servers.mobile_mcp_server import (
...
import pytest
import requests
from alien.client.mcp.mcp_server_manager import HTTPMCPServer
...
Learn how to configure the ALIEN client to connect to your MCP server and enable device agent execution.
