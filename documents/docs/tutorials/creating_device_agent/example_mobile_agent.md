...
- Integrate with Network orchestration
...
| Component | File Path |
|-----------|-----------|
| Agent Class | `alien/agents/agent/customized_agent.py` |
| Processor | `alien/agents/processors/customized/customized_agent_processor.py` |
| Strategies | `alien/agents/processors/strategies/linux_agent_strategy.py` |
| States | `alien/agents/states/linux_agent_state.py` |
| Prompter | `alien/prompter/customized/linux_agent_prompter.py` |
| MCP Server | `alien/client/mcp/http_servers/linux_mcp_server.py` |
