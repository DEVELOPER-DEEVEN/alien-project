...
- **[HostAgent Strategy](../Alien-Unis/host_agent/strategy.md)** - Learn how HostAgent orchestrates third-party agents
- **[AppAgent Strategy](../Alien-Unis/app_agent/strategy.md)** - Processing strategies reference
