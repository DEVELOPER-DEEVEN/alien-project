...
| --- | --- | --- | --- |
| **[Help Documents](./help_document_provision.md)** | Provide application-specific guidance and instructions to help the agent understand tasks and workflows | [Provision Guide](./help_document_provision.md) | [Learning from Help Documents](../../alien2/core_features/knowledge_substrate/learning_from_help_document.md) |
| **[User Demonstrations](./demonstration_provision.md)** | Supply recorded user interactions to teach the agent how to perform specific tasks through examples | [Provision Guide](./demonstration_provision.md) | [Learning from Demonstrations](../../alien2/core_features/knowledge_substrate/learning_from_demonstration.md) |
...
- [AppAgent Overview](../../alien2/app_agent/overview.md) - Understanding AppAgent architecture
- [Knowledge Substrate](../../alien2/core_features/knowledge_substrate/overview.md) - How knowledge enhancement works
...
- [Hybrid GUI–API Actions](../../alien2/core_features/hybrid_actions.md) - Understanding dual-mode automation
