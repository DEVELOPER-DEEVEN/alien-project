...
After creating the offline indexer, refer to the [Learning from User Demonstrations](../../Alien-Unis/core_features/knowledge_substrate/learning_from_demonstration.md) section for guidance on how to use human demonstrations to enhance the AppAgent.
