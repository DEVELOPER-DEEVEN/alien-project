...
- [Hybrid GUI–API Actions](../../alien2/core_features/hybrid_actions.md) - How AppAgent chooses tools
- [Knowledge Substrate Overview](../../alien2/core_features/knowledge_substrate/overview.md) - Understanding the RAG architecture
