...
After configuration, you can start using ALIEN with the Gemini API. Refer to the [Quick Start Guide](../../getting_started/quick_start_alien2.md) for detailed instructions on running your first tasks.