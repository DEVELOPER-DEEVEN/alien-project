...
Configure the `OPERATOR` in the `config/Alien/agents.yaml` file to use the Azure OpenAI Operator model.
...
Edit `config/Alien/agents.yaml` with your Operator configuration:
...
## Step 3: Run Operator in Alien

Alien supports running Operator in two modes:
...
- [Operator as AppAgent](../../Alien-Unis/advanced_usage/operator_as_app_agent.md) - How to integrate Operator into Alien workflows
