...
Configure token pricing for different LLM models to track and estimate API costs during ALIEN² execution.

---

## Overview

The `prices.yaml` file defines the cost per 1,000 tokens for different LLM models. ALIEN² uses this information to calculate and report the estimated cost of task executions.

**File Location**: `config/alien/prices.yaml`
...
ALIEN² automatically tracks costs when pricing information is available.

### During Execution

```python
# ALIEN² automatically calculates costs
Session logs show:
