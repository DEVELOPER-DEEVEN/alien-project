...
You can customize prompts by creating your own YAML files and updating these paths. See the [Customization Guide](../../alien2/advanced_usage/customization.md) for details.
