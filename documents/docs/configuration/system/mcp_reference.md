...
This document provides a quick reference for MCP (Model Context Protocol) server configuration in Alien².
...
**Configuration File**: `config/Alien/mcp.yaml`
