...
Quick answers to common questions about Alien³ cluster, Alien², Linux Agents, and general troubleshooting.
...
- **Alien³ cluster** - Multi-device orchestration framework  
...
|----------|-------------------|
| Windows desktop automation only | [Alien²](getting_started/quick_start_Alien-Unis.md) |
| Cross-device workflows (Windows + Linux) | [Alien³ cluster](getting_started/quick_start_cluster.md) |
| Linux server management only | [Linux Agent](getting_started/quick_start_linux.md) |
| Multi-device orchestration | [Alien³ cluster](getting_started/quick_start_cluster.md) |

### Q: What's the difference between Alien² and Alien³ cluster?
...
**Alien³ cluster** orchestrates multiple devices with:
- Cross-platform support (Windows + Linux)
- Distributed task execution
- Device capability-based routing
- network-based DAG orchestration

See [Migration Guide](getting_started/migration_Alien-Unis_to_cluster.md) for details.
...
|-----------|-----------------|---------|
| **networkAgent** (cluster) | ✅ Yes | Orchestration reasoning |
...
## 🌌 Alien³ cluster Questions

### Q: What's the minimum number of devices for cluster?

**A:** cluster requires **at least 1 device agent** (Windows or Linux) to be useful, but you can start with just one device and add more later.

```yaml
# Minimal cluster setup (1 device)
devices:
...
### Q: Can cluster mix Windows and Linux devices?

**A:** Yes! cluster can orchestrate heterogeneous devices:
...
cluster automatically routes tasks based on device capabilities.
...
### Q: How does cluster decide which device to use?

**A:** cluster uses **capability-based routing**:
...
### Issue: "Device not connecting to cluster"
...
### Issue: "device_id mismatch in cluster"
...
| Topic | Link |
|-------|------|
| **Getting Started** | [Alien² Quick Start](getting_started/quick_start_Alien-Unis.md), [cluster Quick Start](getting_started/quick_start_cluster.md), [Linux Quick Start](getting_started/quick_start_linux.md) |
...
3. **Validate configuration:**
   ```bash
   python -m Alien.tools.validate_config Alien --show-config
   python -m Alien.tools.validate_config cluster --show-config
   ```
