...
data_collection_servers:
  - namespace: screenshot_collector
    type: local
    module: alien.client.mcp.local_servers.screenshot_server
    reset: false
  - namespace: ui_collector
    type: local
    module: alien.client.mcp.local_servers.ui_server
    reset: false

action_servers:
  - namespace: gui_automator
    type: local
    module: alien.client.mcp.local_servers.automation_server
    reset: false
```
