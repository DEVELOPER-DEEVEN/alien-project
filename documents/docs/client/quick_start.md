...
User=Alienuser
Group=Alienuser
WorkingDirectory=/home/Alienuser/Alien-Unis
...
nssm set AlienClient AppDirectory "C:\Alien-Unis"
...
# Set logging
nssm set AlienClient AppStdout "C:\Alien-Unis\logs\client-stdout.log"
nssm set AlienClient AppStderr "C:\Alien-Unis\logs\client-stderr.log"
```
