...
ALIEN uses a **push model** for device information: clients proactively send their profile during registration, rather than waiting for the server to request it. This reduces latency for orion (multi-client) scenarios.
