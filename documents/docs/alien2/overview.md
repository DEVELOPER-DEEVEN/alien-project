...
[![github](https://img.shields.io/github/stars/microsoft/ALIEN)](https://github.com/DEVELOPER-DEEVEN/alien-project)&ensp;
...
!!!tip "Complete Setup Guide"
    For detailed installation, configuration, and advanced usage options, see the **[Quick Start Guide](../getting_started/quick_start_alien2.md)**.
