...
ALIEN can ask users for additional context or information when needed and save it in local memory for future reference. This customization feature enables a more personalized user experience by remembering user-specific information across sessions.

## Example Scenario

Consider a task where ALIEN needs to book a cab. To complete this task, ALIEN requires the user's address. ALIEN will:
...
Configure the customization feature in `config/alien/system.yaml`:
