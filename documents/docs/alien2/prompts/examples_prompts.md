...
Example prompts provide demonstration examples for in-context learning. They are stored in the `alien/prompts/examples` directory with the following subdirectories:
