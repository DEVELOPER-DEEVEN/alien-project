...
Configure the `EvaluationAgent` in `config/alien/system.yaml`:
...
The input construction is handled by the `EvaluationAgentPrompter` class in `alien/prompter/eva_prompter.py`.
...
- [Logs Overview](logs/overview.md) - Complete guide to ALIEN logging system
- [Benchmark Overview](benchmark/overview.md) - Benchmarking ALIEN performance using evaluation results
