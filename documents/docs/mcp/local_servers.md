...
| **OrionEditor** | Action | Multi-device task orchestration | **[→ Full Docs](servers/orion_editor.md)** |
...
**[→ See complete OrionEditor documentation](servers/orion_editor.md)** for multi-device workflow tools.
...
- [HostAgent Overview](../alien2/host_agent/overview.md) - HostAgent architecture
- [AppAgent Overview](../alien2/app_agent/overview.md) - AppAgent architecture
- [Hybrid Actions](../alien2/core_features/hybrid_actions.md) - GUI + API dual-mode automation
