...
**Every action tool's implementation directly affects what the LLM sees and understands.** The Alien² framework automatically extracts:
...
Alien² provides several built-in action servers for different automation scenarios. Below is a summary - click each server name for detailed documentation including all tools, parameters, and usage examples.
...
| **[networkEditor](servers/network_editor.md)** | Multi-Device | Create and manage multi-device task workflows | [Full Details →](servers/network_editor.md) |
...
Action servers are configured in `config/Alien/mcp.yaml`. Each server's documentation provides detailed configuration examples.
...
- [networkEditor Best Practices](servers/network_editor.md)
...
- **Task Distribution**: [networkEditor](servers/network_editor.md)
...
- [HostAgent Commands](../Alien-Unis/host_agent/commands.md) - HostAgent command patterns
- [AppAgent Commands](../Alien-Unis/app_agent/commands.md) - AppAgent action patterns
- [Agent Overview](../Alien-Unis/overview.md) - Alien² agent architecture
