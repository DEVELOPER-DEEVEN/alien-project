...
| **OrionEditor** | Multi-device coordination | `create_task`, `assign_device` | Cross-platform |
...
OrionAgent:
  default:
    action:
      - namespace: OrionEditor  # Create and assign tasks
```
...
- [Agent Overview](../alien2/overview.md) - ALIEN² agent system architecture
