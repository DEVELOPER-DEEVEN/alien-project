...
### Client Configuration (ALIEN² Agent)
...
python -m alien.client.mcp.http_servers.mobile_mcp_server --server data --host 0.0.0.0 --data-port 8020

# Start only action server
python -m alien.client.mcp.http_servers.mobile_mcp_server --server action --host 0.0.0.0 --action-port 8021
```
...
```bash
python -m alien.client.mcp.http_servers.mobile_mcp_server --adb-path "C:\custom\path\adb.exe"
```
...
python -m alien.client.mcp.http_servers.mobile_mcp_server --data-port 8030 --action-port 8031
```
