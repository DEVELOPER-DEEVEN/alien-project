...
**OrionEditor** provides multi-device task coordination and dependency management for distributed workflows in ALIEN².
...
| **Server Name** | `ALIEN Orion Editor MCP Server` |
...
| **Bulk Operations** | `build_orion` | Build complete orion from config |

## Task Management Tools

### add_task

Add a new task to the orion.
...
`str` - JSON representation of complete TaskOrion after adding task
...
Remove a task from the orion (also removes all dependencies involving this task).
...
`str` - JSON representation of orion after removal
...
`str` - JSON representation of orion after update
...
`str` - JSON representation of orion after adding dependency
...
Build a complete orion from configuration data (batch creation).
...
`str` - JSON representation of built orion
...
- [Configuration Guide](../configuration.md) - Orion setup
