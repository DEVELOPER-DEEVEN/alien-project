...
# Enhancing Alien with RAG using Offline Help Documents
...
Once you have all documents ready in a folder named `path_of_the_docs`, you can easily create an offline indexer to support RAG for Alien. Follow these steps:
...
To enable this in online inference, you can set the following configuration in the `Alien/config/config.yaml` file:
```bash
