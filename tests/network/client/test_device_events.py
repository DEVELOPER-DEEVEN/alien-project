...
"""
Test device event publishing in OrionDeviceManager
"""
...
from network.client.components import DeviceStatus
from network.core.events import EventType, DeviceEvent, IEventObserver
...
async def test_device_connected_event():
    ...
    manager = OrionDeviceManager(task_name="test_task")
