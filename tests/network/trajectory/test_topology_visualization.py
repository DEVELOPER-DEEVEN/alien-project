...
from network.trajectory.network_parser import NetworkTrajectory
...
def test_topology_visualization():
    ...
    # Create a temporary NetworkTrajectory instance just to use the image generation method
    # We'll use a fake path since we're only testing the visualization method
    temp_trajectory = NetworkTrajectory.__new__(NetworkTrajectory)
