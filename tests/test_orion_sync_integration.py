...
"""
Integration tests for OrionModificationSynchronizer with Orchestrator.
...
def synchronizer(orchestrator):
    ...
    sync = OrionModificationSynchronizer(
...
@pytest.fixture
def simple_orion():
    """Create a simple linear orion for testing."""
    orion = TaskOrion(orion_id="test_orion")
...
class MockAgent:
    """Mock agent for testing orion modifications."""
    ...
    async def on_task_completion(self, event: TaskEvent):
        ...
        # Simulate orion modification work
        ...
        mod_event = OrionEvent(
            ...
            orion_id=event.data.get("orion_id", "unknown"),
...
class TestRaceConditionPrevention:
    ...
    async def test_orchestrator_waits_for_agent_modification(
        ...
        3. Agent starts modifying orion
    ...
    async def test_multiple_concurrent_modifications(self, event_bus, synchronizer):
        ...
        for task_id in task_ids:
            event = TaskEvent(
                ...
                task_id=task_id,
                task_name=task_id,
                data={"orion_id": "concurrent_orion"},
            )
...
class TestErrorRecoveryIntegration:
    ...
    async def test_task_failure_with_modification(self, event_bus, synchronizer):
        ...
        # Agent handles failure and modifies orion
        await asyncio.sleep(0.1)
        mod_event = OrionEvent(
            event_type=EventType.ORION_MODIFIED,
            source_id="agent",
