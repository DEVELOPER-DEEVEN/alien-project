...
"""
Integration tests for networkModificationSynchronizer with Orchestrator.
...
def synchronizer(orchestrator):
    ...
    sync = networkModificationSynchronizer(
...
def simple_network():
    ...
    network = Tasknetwork(network_id="test_network")
...
class MockAgent:
    """Mock agent for testing network modifications."""
    ...
    async def on_task_completion(self, event: TaskEvent):
        ...
        # Simulate network modification work
        ...
        mod_event = networkEvent(
            ...
            network_id=event.data.get("network_id", "unknown"),
...
class TestRaceConditionPrevention:
    ...
    async def test_orchestrator_waits_for_agent_modification(
        ...
        3. Agent starts modifying network
    ...
    async def test_multiple_concurrent_modifications(self, event_bus, synchronizer):
        ...
        for task_id in task_ids:
            event = TaskEvent(
                ...
                task_id=task_id,
                task_name=task_id,
                data={"network_id": "concurrent_network"},
            )
...
class TestTimeoutScenarios:
    ...
    async def test_orchestrator_proceeds_on_agent_timeout(
        ...
        task_event = TaskEvent(
            ...
            data={"network_id": "timeout_network"},
        )
        await event_bus.publish_event(task_event)
        await asyncio.sleep(0.05)
...
class TestErrorRecoveryIntegration:
    ...
    async def test_task_failure_with_modification(self, event_bus, synchronizer):
        ...
        # Agent handles failure and modifies network
        await asyncio.sleep(0.1)
        mod_event = networkEvent(
            event_type=EventType.network_MODIFIED,
            source_id="agent",
