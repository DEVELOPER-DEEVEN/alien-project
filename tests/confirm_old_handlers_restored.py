...
def main():
    ...
    print(f"✅ 星座处理器: {type(observer._orion_handler).__name__}")
    ...
    print(f"   🔄 Observer 使用旧的OrionVisualizationHandler处理星座事件")
    ...
    print(
        "   ✅ 如需扩展功能，可在TaskVisualizationHandler和OrionVisualizationHandler中添加逻辑"
    )
