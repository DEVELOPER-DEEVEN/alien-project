...
from Alien.agents.presenters import RichPresenter, PresenterFactory
...
class TestAgentPresenterIntegration(unittest.TestCase):
    ...
    @patch('Alien.agents.presenters.rich_presenter.Console')
    def test_network_agent_print_response(self, mock_console_class):
        """Test that networkAgent's print_response uses presenter correctly"""
        ...
        # Create mock response
        response = Mock(spec=networkAgentResponse)
        response.thought = "Creating network"
        ...
        # Create presenter and test
        presenter = RichPresenter(console=mock_console)
        presenter.present_network_agent_response(response, print_action=False)
...
class TestPresenterOutputConsistency(unittest.TestCase):
    ...
    @patch('Alien.agents.presenters.rich_presenter.Console')
    def test_network_operation_formatting(self, mock_console_class):
        """Test that network operations are formatted correctly"""
