...
class TestAgentPresenterIntegration(unittest.TestCase):
    ...
    @patch('alien.agents.presenters.rich_presenter.Console')
    def test_orion_agent_print_response(self, mock_console_class):
        """Test that OrionAgent's print_response uses presenter correctly"""
        ...
        # Create mock response
        response = Mock(spec=OrionAgentResponse)
        response.thought = "Creating orion"
        ...
        # Create presenter and test
        presenter = RichPresenter(console=mock_console)
        presenter.present_orion_agent_response(response, print_action=False)
...
class TestPresenterOutputConsistency(unittest.TestCase):
    ...
    @patch('alien.agents.presenters.rich_presenter.Console')
    def test_orion_operation_formatting(self, mock_console_class):
        """Test that orion operations are formatted correctly"""
