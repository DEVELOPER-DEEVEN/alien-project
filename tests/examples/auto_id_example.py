...
This example shows how orion_id, task_id, and line_id are automatically
generated when not provided, and how uniqueness is enforced within orion contexts.
"""
...
def example_mixed_ids():
    ...
    # 创建星座
    orion = TaskOrionSchema(
        orion_id="mixed_mode_orion",  # 手动指定
        name="混合模式星座",
    ...
    print(f"   - 手动星座 ID: {orion.orion_id}")
...
def example_json_serialization():
    ...
    # 创建包含自动生成 ID 的星座
    orion = TaskOrionSchema(name="JSON 测试星座")
...
def main():
    ...
    # 运行各种示例
    orion1 = example_basic_auto_id()
    orion2 = example_mixed_ids()
    orion3 = example_sequential_generation()
