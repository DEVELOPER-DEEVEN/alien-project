...
"""
BaseModel Integration Example for TaskStar, TaskStarLine, and TaskOrion.

This example demonstrates how to use the Pydantic BaseModel schemas for
serialization, deserialization, and data validation with the orion classes.
"""
...
def example_json_persistence():
    ...
    # 创建复杂的星座
    orion = TaskOrion(
        orion_id="example_orion", name="示例任务星座"
    )
...
def example_api_integration():
    ...
    try:
        ...
        # 获取任务并检查属性
        task = list(orion.tasks.values())[0]
