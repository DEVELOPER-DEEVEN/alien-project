...
from network.orion.editor.command_interface import IUndoableCommand
from network.orion.editor.commands import AddTaskCommand
...
def test_simple_undo():
    ...
    command = AddTaskCommand(editor.orion, task)
