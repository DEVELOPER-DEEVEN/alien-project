...
from cluster.network.editor.command_interface import IUndoableCommand
from cluster.network.editor.commands import AddTaskCommand
...
def test_simple_undo():
    ...
    command = AddTaskCommand(editor.network, task)
