...
orion_dir = os.path.join(current_dir, "alien", "network", "orion")
...
def test_individual_files():
    ...
    task_star_file = os.path.join(orion_dir, "task_star.py")
...
def test_method_signatures():
    ...
    orion_dir = os.path.join(
        os.path.dirname(os.path.abspath(__file__)), "alien", "network", "orion"
    )
    task_star_file = os.path.join(orion_dir, "task_star.py")
    task_star_line_file = os.path.join(orion_dir, "task_star_line.py")
