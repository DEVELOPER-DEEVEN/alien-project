...
network_dir = os.path.join(current_dir, "Alien", "cluster", "network")
...
def test_individual_files():
    ...
    task_star_file = os.path.join(network_dir, "task_star.py")
    task_star_line_file = os.path.join(network_dir, "task_star_line.py")
...
def test_method_signatures():
    ...
    network_dir = os.path.join(
        os.path.dirname(os.path.abspath(__file__)), "Alien", "cluster", "network"
    )
    task_star_file = os.path.join(network_dir, "task_star.py")
    task_star_line_file = os.path.join(network_dir, "task_star_line.py")
