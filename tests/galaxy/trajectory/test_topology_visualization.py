...
from cluster.trajectory.cluster_parser import clusterTrajectory
...
def test_topology_visualization():
    ...
    # Create a temporary clusterTrajectory instance just to use the image generation method
    # We'll use a fake path since we're only testing the visualization method
    temp_trajectory = clusterTrajectory.__new__(clusterTrajectory)
