...
"""
Test device event publishing in networkDeviceManager
"""
...
from cluster.client.components import DeviceStatus
from cluster.core.events import EventType, DeviceEvent, IEventObserver
...
async def test_device_connected_event():
    ...
    manager = networkDeviceManager(task_name="test_task")
