"""
Tests for cluster WebUI WebSocket Server.
"""
...
async def test_websocket_connection():
    ...
    with TestClient(app) as client:
        with client.websocket_connect("/ws") as websocket:
            ...
            assert "Connected to cluster Web UI" in data["message"]
...
async def test_websocket_request_without_client():
    """Test sending request when cluster client is not set."""
    with TestClient(app) as client:
        with client.websocket_connect("/ws") as websocket:
            # Receive welcome message
            websocket.receive_json()

            # Send request without cluster client
