...
# Test files to run
TEST_FILES = [
    "tests/cluster/client/test_cluster_client_cancellation.py",
    "tests/cluster/session/test_session_cancellation.py",
    "tests/cluster/network/test_orchestrator_cancellation.py",
    "tests/cluster/webui/test_webui_stop_integration.py",
]
