...
from alien.tools.convert_config import ConfigConverter
...
class TestConfigConversion(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.legacy_config_path = cls.project_root / "alien" / "config"
        cls.new_config_path = cls.project_root / "config" / "alien"
