...
class TestConfigMigrator(unittest.TestCase):
    ...
    def create_legacy_config(self):
        ...
        legacy_path = Path(self.test_dir) / "alien/config"
    ...
    def test_check_legacy_exists(self):
        ...
        from alien.tools.migrate_config import ConfigMigrator
    ...
    def test_dry_run_migration(self):
        ...
        new_path = Path(self.test_dir) / "config/alien"
    ...
    def test_migration_preserves_content(self):
        ...
        legacy_file = Path(self.test_dir) / "alien/config/config.yaml"
        new_file = Path(self.test_dir) / "config/alien/config.yaml"
