...
class TestConfigValidator(unittest.TestCase):
    ...
    def test_valid_alien_config(self):
        """Test validation of valid ALIEN configuration."""
        from alien.tools.validate_config import ConfigValidator
        ...
        self.create_config_file("config/alien/agents.yaml", config)

        validator = ConfigValidator("alien")
    ...
    def test_path_detection_legacy_only(self):
        ...
        self.create_config_file("alien/config/config.yaml", config)
...
class TestNetworkValidator(unittest.TestCase):
    ...
    def test_valid_network_config(self):
        ...
        self.create_config_file("config/network/agent.yaml", config)

        validator = ConfigValidator("network")
        result = validator.validate_structure()

        self.assertTrue(result)

    def test_network_no_legacy_path(self):
        """Test that Network validator doesn't check legacy path."""
        from alien.tools.validate_config import ConfigValidator

        validator = ConfigValidator("network")

        # Network should not have legacy path
