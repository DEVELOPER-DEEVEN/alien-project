...
# Import real enums from Network framework
...
# Simple TaskOrion for testing
class SimpleTaskOrion:
    def __init__(
        self,
        orion_id: str = None,
        name: str = None,
        ...
        self.orion_id = (
            orion_id
            or f"test_orion_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
        )
        self.name = name or self.orion_id
        self.state = OrionState.CREATED
    ...
    def complete_execution(self, success: bool = True):
        self.state = OrionState.COMPLETED
    ...
    def get_all_tasks(self):
        """Return all tasks in the orion."""
        return list(self._tasks.values())

    def get_all_dependencies(self):
        """Return all dependencies in the orion."""
        return list(self._dependencies.values())

    def get_statistics(self):
        """Return orion statistics."""
...
def test_dag_visualization():
    ...
    for task_id in [
        ...
        orion.mark_task_completed(task_id, success=True)
