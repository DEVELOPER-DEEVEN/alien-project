"""
Comprehensive Unit Tests for network Client AIP Migration
...
from cluster.client.components.connection_manager import WebSocketConnectionManager
from cluster.client.components.heartbeat_manager import HeartbeatManager
from cluster.client.components.message_processor import MessageProcessor
from cluster.client.components.device_registry import DeviceRegistry
from cluster.client.components.types import AgentProfile, TaskRequest
...
class TestMessageFormatCompatibility:
    ...
    def test_registration_message_format(self):
        """Test network registration message format."""
        ...
        assert reg_msg.client_type == ClientType.network
        assert reg_msg.client_id == network_id
    ...
    def test_task_message_format(self):
        ...
        task_msg = ClientMessage(
            ...
            task_name="cluster/test_network/excel_task",
            request="Open Excel and create a spreadsheet",
            session_id="test_network@task_123",
            timestamp=datetime.now(timezone.utc).isoformat(),
        ...
        assert task_msg.client_type == ClientType.network
    ...
    def test_device_info_request_format(self):
        ...
        assert request_msg.client_type == ClientType.network
...
class TestProtocolBehaviorConsistency:
    ...
    async def test_error_handling_consistency(self):
        ...
        success = await protocol.register_as_network(
            network_id="test@invalid_device",
