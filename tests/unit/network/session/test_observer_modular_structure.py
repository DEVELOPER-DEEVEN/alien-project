...
def test_modular_imports():
    ...
    try:
        from network.session.observers.base_observer import (
            OrionProgressObserver as DirectProgressObserver,
...
def test_observer_modules():
    ...
    expected_modules = {
        OrionProgressObserver: "alien.network.session.observers.base_observer",
        SessionMetricsObserver: "alien.network.session.observers.base_observer",
        DAGVisualizationObserver: "alien.network.session.observers.dag_visualization_observer",
    }
...
def test_backward_compatibility():
    ...
    try:
        ...
        # Test that NetworkSession can still import observers
        import network.session.network_session as gs_module

        # Check that network_session.py can access the observers
        assert hasattr(gs_module, "OrionProgressObserver")
