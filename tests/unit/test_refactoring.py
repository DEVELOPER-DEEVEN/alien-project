...
"""
Test script to validate the refactored Orion Agent strategies and prompters.
...
def test_strategy_factory():
    """Test the OrionStrategyFactory."""
    print("Testing OrionStrategyFactory...")
...
def test_prompter_factory():
    """Test the OrionPrompterFactory."""
    print("Testing OrionPrompterFactory...")
...
def main():
    """Run all tests."""
    print("=" * 60)
    print("Testing Refactored Orion Agent Architecture")
    print("=" * 60)
