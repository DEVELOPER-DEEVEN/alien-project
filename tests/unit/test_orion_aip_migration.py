"""
Comprehensive Unit Tests for Orion Client AIP Migration
...
from network.client.components.connection_manager import WebSocketConnectionManager
from network.client.components.heartbeat_manager import HeartbeatManager
from network.client.components.message_processor import MessageProcessor
from network.client.components.device_registry import DeviceRegistry
from network.client.components.types import AgentProfile, TaskRequest
...
class TestMessageFormatCompatibility:
    ...
    def test_registration_message_format(self):
        """Test orion registration message format."""
        ...
        assert reg_msg.client_type == ClientType.ORION
        assert reg_msg.client_id == orion_id
    ...
    def test_task_message_format(self):
        ...
        task_msg = ClientMessage(
            ...
            task_name="network/test_orion/excel_task",
            request="Open Excel and create a spreadsheet",
            session_id="test_orion@task_123",
            timestamp=datetime.now(timezone.utc).isoformat(),
        ...
        assert task_msg.client_type == ClientType.ORION
    ...
    def test_device_info_request_format(self):
        ...
        assert request_msg.client_type == ClientType.ORION
