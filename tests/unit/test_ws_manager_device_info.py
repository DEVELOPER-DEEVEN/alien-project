...
class TestWSManagerAgentProfile:
    ...
    def test_add_orion_client_no_system_info(self):
        """Test that orion clients don't get system info processing"""
        ws_manager = WSManager()
        mock_ws = Mock(spec=WebSocket)
        ...
        client_info = ws_manager.online_clients["orion_001"]
    ...
    def test_get_all_devices_info(self):
        ...
        # Add a orion (should not be included)
        ws_manager.add_client(
            "orion_001",
            mock_ws3,
            ClientType.ORION,
        ...
        assert "orion_001" not in all_info
