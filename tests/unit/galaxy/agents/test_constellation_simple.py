...
"""
Simplified test cases for the refactored network Agent factory patterns.
...
class TestnetworkRefactor:
    """Simplified test cases for network refactor."""
    ...
    def test_strategy_factory_handles_invalid_mode(self):
        ...
        with pytest.raises(ValueError, match="Unsupported weaving mode"):
            networkStrategyFactory.create_llm_interaction_strategy("INVALID")

        with pytest.raises(ValueError, match="Unsupported weaving mode"):
            networkStrategyFactory.create_action_execution_strategy("INVALID")
