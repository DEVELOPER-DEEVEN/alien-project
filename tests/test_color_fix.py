...
"""
Quick test to verify color display in orion_modified method.
"""
...
from network.visualization.orion_display import OrionDisplay
...
class MockOrion:
    def __init__(self):
        ...
        self.orion_id = "12345678-abcd-efgh-ijkl-mnopqrstuvwx"
...
def test_color_display():
    ...
    print("Testing orion modification display with colors:")
    print("=" * 60)
