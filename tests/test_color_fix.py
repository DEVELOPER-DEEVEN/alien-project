...
"""
Quick test to verify color display in network_modified method.
"""
...
from cluster.visualization.network_display import networkDisplay
...
class Mocknetwork:
    def __init__(self):
        ...
        self.network_id = "12345678-abcd-efgh-ijkl-mnopqrstuvwx"
...
def test_color_display():
    ...
    print("Testing network modification display with colors:")
    print("=" * 60)

    # Display the modification
    display.display_network_modified(network, changes, additional_info)
