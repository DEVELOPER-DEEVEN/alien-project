...
Tests endpoint implementations for server, client, and orion.
"""
...
class TestOrionEndpoint:
    """Test orion endpoint."""

    @pytest.mark.asyncio
    async def test_endpoint_creation(self):
        """Test creating orion endpoint."""
...
class TestBackwardCompatibility:
    ...
    def test_import_from_contracts(self):
        """Test importing from alien.contracts.contracts works."""
