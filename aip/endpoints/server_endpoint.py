...
Wraps the existing ALIEN server WebSocket handler with AIP protocol abstractions.
...
class DeviceServerEndpoint(AIPEndpoint):
    ...
    Wraps the existing ALIENWebSocketHandler to provide AIP protocol support
    ...
    def __init__(
        ...
        self.handler = ALIENWebSocketHandler(ws_manager, session_manager, local)
    ...
    async def handle_websocket(self, websocket: WebSocket) -> None:
        ...
        This delegates to the existing ALIENWebSocketHandler for full compatibility.
