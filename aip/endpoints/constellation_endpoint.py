...
Wraps the existing cluster network client with AIP protocol abstractions.
"""
...
class networkEndpoint(AIPEndpoint):
    """
    network Client endpoint for AIP.
    ...
    def __init__(
        ...
        :param task_name: Task name for this network
        ...
        self.logger = logging.getLogger(f"{__name__}.networkEndpoint")

    async def start(self) -> None:
        """Start the endpoint."""
        self.logger.info(f"network endpoint started for {self.task_name}")

    async def stop(self) -> None:
        """Stop the endpoint and disconnect all devices."""
        self.logger.info("Stopping network endpoint")
    ...
    async def on_device_disconnected(self, device_id: str) -> None:
        ...
        :param device_id: Device ID
        """
        self.logger.warning(f"Device {device_id} disconnected from network")
